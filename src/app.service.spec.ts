...
describe('AppController', () => {
  ...
  describe('Test data from API', () => {
    ...
    test('Get failure result of the API call - start date after end date', async () => {
      await appService
    ...
    test('Get failure result of the API call - wrong date format data', async () => {
      await appService
  ...
  describe('Test API keys', () => {
    ...
    test('demo API key', async () => {
      console.log(
        ...
        }&start_date=2022-11-01&end_date=2022-12-04`,
      );
      await axios
        .get(
          `${
